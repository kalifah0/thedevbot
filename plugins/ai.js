...
malvin({
    ...
    try {
        ...
        // Image AI à envoyer
        const ALIVE_IMG = 'https://files.catbox.moe/o0w1lj.png'; // Remplacez par l'URL de votre image AI
...
malvin({
    ...
    try {
        ...
        // AI image to attach
        const AI_IMG = 'https://files.catbox.moe/o0w1lj.png'; // Replace with a valid image URL
