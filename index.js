...
if (!fs[_0x1d324b(0x2ae)](__dirname + _0x1d324b(0x246))) {
    ...
    const sessdata = config['SESSION_ID'][_0x1d324b(0x2d5)]('Hassan~', ''),
...
app.get("/pair", (req, res) => {
  res.send(\`
    Hello there THEDEVBOT user! 👋🏻<br><br>
    > Do not share your session id with anyone.<br><br>
    Thanks for using THEDEVBOT🚩<br><br>
    > Join WhatsApp Channel :- ⤵️<br>
    <a href="https://whatsapp.com/channel/0029Vb6rSz04yltQhAycK12U">https://whatsapp.com/channel/0029Vb6rSz04yltQhAycK12U</a><br><br>
    Dont forget to fork the repo ⬇️<br>
    <a href="https://github.com/kalifah0/thedevbot">https://github.com/kalifah0/thedevbot</a><br><br>
